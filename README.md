...
2.  **Apply the manifests:**
    ...
    *To enable the automatic self-updater in Kubernetes, ensure the pod's service account has strategic-merge patch permissions on `deployments/scrollarr` within its namespace.*
