...
class SettingsRequest(BaseModel):
    ...
    discord_check_interval_hours: int = 1
...
async def update_settings(settings: SettingsRequest):
    ...
    try:
        updates = {
            ...
            "discord_check_interval_hours": settings.discord_check_interval_hours,
        }

        if settings.discord_token and settings.discord_token != "********":
            updates["discord_token"] = settings.discord_token
